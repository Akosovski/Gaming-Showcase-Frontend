...
export default function Page() {
  return (
    <div>
        ...
        <div className="grid grid-rows-2 justify-center mt-10">
          <div className="drop-shadow-lg w-[280px] h-[110px] overflow-hidden ">
            <Image src={genshinlogo}></Image>
          </div>
        </div>

        <div className="flex flex-rows flex-wrap p-3 gap-6 justify-center -mt-16 max-[900px]:mx-0 max-[1366px]:mx-24 min-[1366px]:mx-44">
